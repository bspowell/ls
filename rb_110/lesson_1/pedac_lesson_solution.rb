def sum_even_number_row(row_number)
  ...
  rows.last.sum #sum the final row and return sum
end
...
def create_row(start_integer, row_length)
  ...
  #assigning to new variable since we alter the start_integer, which fully clear
  loop do
    row << current_integer
    current_integer += 2
...
# 	- add sub steps or create a new problem case (see below)
...
# - Move back and forawrd between the steps
