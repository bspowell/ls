...
puts [Length.new(1, :mi), Length.new(1, :nmi), Length.new(1, :km)].sort_by { |x| x.as_kilometers.value }
...
=begin
This failed because when sorting an array, sort needs to have all the objects the
same. Where here we are creatign a new Length object for each element in the array it's
sorting. 
